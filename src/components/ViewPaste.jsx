import { Copy, Share, Calendar, FileText, User, Lock } from "lucide-react";
...
const ViewPaste = () => {
  ...
  const isOwner = paste?.owner === currentUser;
        ...
        {!isOwner && (
          <div className="mb-6 p-4 bg-yellow-50 border border-yellow-200 rounded-xl">
            ...
            <p className="text-yellow-700 text-sm mt-1">
              This is a shared paste. You can view and copy the content, but you cannot edit or delete it.
            </p>
          </div>
        )}

        {/* Content */}
        <div className="border-2 border-gray-200 bg-white shadow-lg rounded-2xl overflow-hidden">
